...
-(void)xmTabBarHidden:(BOOL)hidden animated:(BOOL)animated
{
    ...
    duration = animated == YES ? 0.24 : 0;
    
    [UIView animateWithDuration:duration animations:^
    {
        if (hidden)
        {
            self.tabBarView.frame = CGRectMake(0, SCREENHEIGHT + 50, SCREENWIDTH, kTabBarH);
        }
        else
        {
            self.tabBarView.frame = CGRectMake(0, SCREENHEIGHT-kTabBarH, SCREENWIDTH, kTabBarH);
        }
                         ...
                         titles:(NSMutableArray *)titles
{
    if ([super init])
    {
        self.frame = CGRectMake(0, SCREENHEIGHT - kTabBarH, SCREENWIDTH, kTabBarH);
