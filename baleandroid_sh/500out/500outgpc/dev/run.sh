...
APN_NEW_NAME=dev_500outgpc.apk
APK_PATH=/Users/mac/Documents/workspace/svn/500out/game/web/WEB_APP_500outgpc_dev/platforms/android/app/build/outputs/apk/release

#<------------------------------------------------>                  
# 上传服务器时用  
#远程服务器上的路径
SERVER_PATH=/data/Android/500out/500outgpc     
#<------------------------------------------------>  
