...
# 上传服务器时用
#Ipa默认包名
IPA_NAME=dev_500outtlgpc.ipa  
#远程服务器上的路径
SERVER_PATH=/data/ios/500out/500outtlgpc      
#<------------------------------------------------>  
...
# 打包api时用
#工程名
PROJECT_NAME=土楼股彩-dev    # <---------------这里需要修改
#scheme名
SCHEME_NAME=土楼股彩-dev    # <---------------这里需要修改
#<------------------------------------------------> 


# 打包时用
#IOS工程路径
IOS_PATH=/Users/mac/Documents/workspace/svn/500out/game/web/WEB_APP_500outtlgpc_dev/platforms/ios       # <---------------这里需要修改
#判断IPA是否存在路径
IPADir_PATH=${IOS_PATH}/IPADir/Debug   # <---------------这里需要修改
#Plist所在路径
PLIST_PATH=/Users/mac/Documents/workspace/Essence/project_plist/500out/500outtlgpc/dev/plist      # <---------------这里需要修改
