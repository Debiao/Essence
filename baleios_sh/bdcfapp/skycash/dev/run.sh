...
# 上传服务器时用
#Ipa默认包名
IPA_NAME=dev_skycash.ipa 
#远程服务器上的路径
SERVER_PATH=/data/ios/bdcfapp/skycash  
#<------------------------------------------------>  
...
#Plist所在路径
PLIST_PATH=/Users/mac/Documents/workspace/Essence/project_plist/bdcfapp/skycash/dev/plist     # <---------------这里需要修改
