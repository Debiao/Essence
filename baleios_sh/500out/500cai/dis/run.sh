...
#编译cordova路径
NPM_RUN_PATH=/Users/mac/Documents/workspace/svn/500out/game/web/WEB_APP_500cai_dis  # <---------------这里需要修改
cd ${NPM_RUN_PATH}
npm run ios-min
...
# 打包时用
#IOS工程路径
IOS_PATH=/Users/mac/Documents/workspace/svn/500out/game/web/WEB_APP_500cai_dis/platforms/ios     # <---------------这里需要修改
#判断IPA是否存在路径
IPADir_PATH=${IOS_PATH}/IPADir/Debug   # <---------------这里需要修改
#Plist所在路径
PLIST_PATH=/Users/mac/Documents/workspace/Essence/project_plist/500out/500cai/dis/plist/      # <---------------这里需要修改
