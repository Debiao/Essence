...
# 打包api时用
#工程名
PROJECT_NAME=500OUT-dev    # <---------------这里需要修改
#scheme名
SCHEME_NAME=500OUT-dev    # <---------------这里需要修改
#<------------------------------------------------> 


# 打包时用
#IOS工程路径
IOS_PATH=/Users/mac/Documents/workspace/svn/500out/game/web/WEB_APP_500out_dev/platforms/ios       # <---------------这里需要修改
#判断IPA是否存在路径
IPADir_PATH=${IOS_PATH}/IPADir/Debug   # <---------------这里需要修改
#Plist所在路径
PLIST_PATH=/Users/mac/Documents/workspace/Essence/project_plist/500out/500out/dev/plist/       # <---------------这里需要修改
