...
# 打包时用
#IOS工程路径
IOS_PATH=/Users/mac/Documents/workspace/svn/500out/game/web/WEB_APP_500outtlgpc_dis/platforms/ios       # <---------------这里需要修改
#判断IPA是否存在路径
IPADir_PATH=${IOS_PATH}/IPADir/Debug   # <---------------这里需要修改
#Plist所在路径
PLIST_PATH=/Users/mac/Documents/workspace/Essence/project_plist/500out/500outtlgpc/dis/plist      # <---------------这里需要修改
